...
def config():
    ...
    data_config = deflatten({
        ...
        'transforms': deflatten({
            ...
            '4.input_path': 'mel_spectrogram',
            '4.center_axis': 1,
            '4.scale_axis': (1, 2),
            '5.factory': SegmentAxis,
            '5.axes.audio_data': 1,
            '5.axes.mel_spectrogram': 1,
            '5.segment_steps.audio_data': 16000,
            '5.segment_steps.mel_spectrogram': 100,
            '5.segment_lengths.audio_data': 16000,
            '5.segment_lengths.mel_spectrogram': 102,
            '5.pad': True,
            '6.factory': Declutter,
            '6.required_keys': ['audio_data', 'mel_spectrogram'],
            '6.dtypes.audio_data': 'float32',
            '6.dtypes.mel_spectrogram': 'float32',
            '7.factory': Reshape,
            '7.input_path': 'mel_spectrogram',
            '7.permutation': (0, 1, 3, 2),
            '8.factory': Fragmenter,
            '8.split_axes.audio_data': (0, 1),
            '8.split_axes.mel_spectrogram': (0, 1),
            '8.squeeze': True
        }),
        'fragment': True,
        'max_workers': 16,
    ...
    train_config = deflatten({
        ...
        'model.feature_key': 'mel_spectrogram',
...
def train(data_config, train_config):
    ...
    train_iter, validation_iter = data_provider.get_iterables()
